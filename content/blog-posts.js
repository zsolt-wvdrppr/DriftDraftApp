...
*Ready to plan your strategic website? Start by clearly defining what success looks like for your business online.*`,
  },
  {
    ...
    publishSchedule: {
      scheduledDate: "2025-07-15T14:30:00Z",
      status: "published",
      scheduledBy: "admin",
    },
    featuredImage: {
...
*The most successful development teams in 2025 will be those that thoughtfully integrate AI tools whilst maintaining focus on user needs and business objectives.*`,
  ...
  {
    id: "nextjs-react-19-performance",
    title: "Maximising Performance with Next.js 15 and React 19",
    publishSchedule: {
      scheduledDate: "2025-07-20T11:15:00Z",
      status: "published",
      scheduledBy: "admin",
    },
    featuredImage: {
...
// Example schema for a blog post with video fields
export const blogPostsSchema = {
  ...
  fields: {
    ...
    publishSchedule: {
      ...
      required: false,
      includeAuthor: true, // Adds the scheduled_by field
    },
    featuredImage: {
      type: "image",
