...
export const updateUrlParams = (currentStep, router) => {
    try {
        // Get the current URL using Next.js Router utilities
        ...
        // Use Next.js router.replace() to update the URL without a reload
  ...
  export const goToPreviousStep = (currentStep, setCurrentStep, updateUrlParams, router) => {
    if (currentStep > 0) {
      setCurrentStep((prev) => prev - 1);
      updateUrlParams(currentStep - 1, router);
    }
