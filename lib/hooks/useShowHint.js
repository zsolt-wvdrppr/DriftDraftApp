              ...
              components={{
                a: ({ node, ...props }) => (
                  <span className="relative flex flex-wrap">
                    ...
                    {checkDomain &&
                      domainList[getDomainPart(props.href)]?.available === undefined && (
                        <IconWorldQuestion
                    ...
                    {checkDomain &&
                      domainList[getDomainPart(props.href)]?.available === true && (
                        <IconWorldQuestion
                          className="text-green-500 mx-1 cursor-pointer"
                          size={16}
                          title="Avaiable domain"
                          onClick={() => {
                            toast.dismiss();
                            handleCheckDomain(props.href);
                          }}
                    ...
                    {checkDomain &&
                      domainList[getDomainPart(props.href)]?.available === false && (
                        <IconWorldQuestion
