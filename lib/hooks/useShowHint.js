            ...
            toast.custom(
              () => (
                <div className="flex flex-col p-4 bg-white shadow-lg rounded-md border">
                  <p className="text-md font-semibold dark:text-default-200">
                    ...
                    {suggestions.map((s) => (
                      <li key={s.domain} className="flex flex-row">
                        <Button
                          ...
                          onPress={() =>
                            handleSelectedCopy(getDomainPart(s.domain))
                          }
                        >
                          <IconCopy
                ...
                a: ({ node, ...props }) => {
                  ...
                  return (
                    <span className="relative flex flex-wrap">
                      <a {...props} className="dark:text-white" rel="noopener noreferrer" target="_blank">
                        {props.children}
                      </a>
                      {checkDomain && !domainList[domainPart] && (
                        <IconWorldQuestion
                          className="text-highlightOrange mx-1 cursor-pointer animate-bounce"
                          size={16}
                      ...
                      <IconCopy
                        ...
                        title="Copy domain name to clipboard"
                        onClick={() =>
                          handleSelectedCopy(getDomainPart(props.href))
                        }
                      />
                    </span>
                  );
