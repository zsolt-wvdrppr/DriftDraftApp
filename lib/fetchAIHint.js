...
export const fetchAIHint = async ({
  ...
  if (cachedPrompt && calculateSimilarityPercentage(prompt, cachedPrompt) > 99.5) {
    ...
    toast.error(`Your input hasn't changed significantly since the last hint. Try adjusting your answer further for a new suggestion.`, {  classNames: { toast: 'text-danger', title: 'text-md font-semibold' } });
