    ...
    <section className="mt-16 pt-8 border-t border-neutralGray/20 dark:border-slate-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <span className="text-neutralDark dark:text-neutral font-medium">
            Share:
          </span>
          <div className="flex gap-3">
            {shareLinks.map((platform) => (
              <button
                ...
                className={`p-2 bg-primary ${platform.colour} text-white rounded-full transition-colors duration-200 group`}
