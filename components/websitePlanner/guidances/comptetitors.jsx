...
Use the copy icon next to each URL to quickly copy the website address to your clipboard. This makes it convenient to check out these sites later as you develop your website strategy.
  `;
