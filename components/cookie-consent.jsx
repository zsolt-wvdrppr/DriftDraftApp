...
const CookieConsent = () => {
  ...
  const initializeGTM = (consentPreferences) => {
    ...
    // Push consent settings to dataLayer following Google's official format
    window.dataLayer.push({
      'consent': 'update',
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          {!showPreferences ? (
            ...
            <>
              <p className="mb-4">
                Customize your cookie preferences. Necessary cookies help make the website usable by enabling basic functions.
              </p>
              ...
              <div className="space-y-4 my-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Help us improve by tracking anonymous usage data.</p>
                  </div>
                  <div className="relative cursor-pointer" onClick={() => handlePreferenceChange('analytics')}>
                    <input
                      type="checkbox"
                      ...
                      className="sr-only"
                    />
                    <div className={`block w-14 h-8 rounded-full ${preferences.analytics ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Allow us to provide personalized ads on other platforms.</p>
                  </div>
                  <div className="relative cursor-pointer" onClick={() => handlePreferenceChange('marketing')}>
                    <input
                      type="checkbox"
                      ...
                      className="sr-only"
                    />
                    <div className={`block w-14 h-8 rounded-full ${preferences.marketing ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
                    <div className={`absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition transform ${preferences.marketing ? 'translate-x-6' : ''}`}></div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Remember your settings and provide enhanced functionality.</p>
                  </div>
                  <div className="relative cursor-pointer" onClick={() => handlePreferenceChange('preferences')}>
                    <input
                      type="checkbox"
                      ...
                      className="sr-only"
                    />
                    <div className={`block w-14 h-8 rounded-full ${preferences.preferences ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
