...
const BlueprintBackground = ({ 
  ...
  if (dimensions.width > 0 && dimensions.height > 0) {
    ...
    if (showCircles) {
      for (let x = gridSize * majorLineFrequency; x <= dimensions.width; x += gridSize * majorLineFrequency) {
        for (let y = gridSize * majorLineFrequency; y <= dimensions.height; y += gridSize * majorLineFrequency) {
