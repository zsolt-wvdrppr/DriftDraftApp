...
const StepEmotions = ({ ref }) => {
  ...
  const isAIAvailable =
    ...
    Provide a framework or examples to articulate these emotions clearly, explaining why they are vital for the landing page’s success. Keep the response conversational, concise, and under 800 characters. Keep the response concise and be creative, use emojis too to express the feelings we want to make the landing page reader to feel, make sure they are relevant.`;
